...
<div data-role="page" data-theme="d" id="pageRwait">
    ...
    <a href="http://112.121.150.67/thaistudentcare/pkteacherh03.php" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
...
WHERE minusbehavior.minus_id  AND minusbehavior.minus_status = 'รอดำเนินการ' AND student.level_id LIKE '3%' AND minusbehavior.minus_leaderlevel != '' AND minusbehavior.minus_admin = ''";
...
FROM minusbehavior  INNER JOIN student INNER JOIN fault INNER JOIN `level`
ON (minusbehavior.stud_id=student.stud_id AND minusbehavior.fault_id=fault.fault_id AND student.level_id=`level`.level_id)
WHERE minusbehavior.minus_id  AND minusbehavior.minus_status = 'รอดำเนินการ' AND student.level_id LIKE '3%' AND minusbehavior.minus_leaderlevel = ''";
...
?>
  ...
  </a><a href="http://112.121.150.67/thaistudentcare/editcutbehaviorh03.php?mbid=<?=$objResult2["minus_id"];?>">รายละเอียด</a></li>
<?
}
?> 
</ul>
...
<li><a href="#">
  ...
  </a><a href="http://112.121.150.67/thaistudentcare/editfinishbvh03.php?mbid=<?=$objResult3["minus_id"];?>">รายละเอียด</a></li>
  <?
}
?> 
</ul>
