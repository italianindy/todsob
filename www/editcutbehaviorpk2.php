...
<div data-role="page" id="pageEbehavior">
    ...
    <a href="http://112.121.150.67/thaistudentcare/reportwaitpk2.php" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
		<h1>รอดำเนินการตัดคะแนน</h1>
	</div>
	
			<form action="saveeditcutbpk2.php?mbid=<?=$objResult2["minus_id"];?>" method="post" id="form1">
       ...
       <p>ครูที่ปรึกษา ครู<? echo $objResult3["teach_fname"];?> <? echo $objResult3["teach_lname"];?> </p>
        <p>ความเห็นหัวหน้าระดับ : <? echo $objResult2["minus_leaderlevelac"];?>  </p>
           <p>ความเห็นผช.รองผู้อำนวยการฝ่ายกิจการนักเรียน : <? echo $objResult2["minus_secondadminac"];?>  </p>
        
       <div data-role="fieldcontain">
         <label for="filpadminac">ความเห็นรองผู้อำนวยการฝ่ายกิจการนักเรียน :</label>
         <select name="filpadminac" id="filpdadminac" data-role="slider">
       ...
       <input name="hidadmin" type="hidden" value="<? echo $objResult["teach_id"];?>">
       <input name="hidleaderlevel" type="hidden" value="<? echo $objResult2["minus_leaderlevel"];?>">
       <input name="hidleaderlevelac" type="hidden" value="<? echo $objResult2["minus_leaderlevelac"];?>">
        <input name="hidsecondadmin" type="hidden" value="<? echo $objResult2["minus_secondadmin"];?>">
       <input name="hidsecondadminac" type="hidden" value="<? echo $objResult2["minus_secondadminac"];?>">
	    <input name="hiddatefault" type="hidden" value="<? echo $objResult2["minus_date"];?>">
<input name="hidcreateid" type="hidden" value="">
<input name="hidstatus" type="hidden" value="เสร็จสิ้น">
