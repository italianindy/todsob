...
<div data-role="page" id="pageRcutbehavior">
	<div data-role="header">
     <a href="http://112.121.150.67/thaistudentcare/searchstudentforcuth05.php?lid=<?=$objResult["level_id"];?>" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
		<h1><font size="3">ใบตัดคะแนนนักเรียน</font></h1>
	</div>
	<div data-role="content">	
		<form action="savecutbh05.php" method="post" id="form1">
