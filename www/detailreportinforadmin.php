...
<div data-role="page" id="pageDreportinforadmin">
...
<div align="right">
	...
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนทั้งหมด : 3,174 คน<br>มาเรียนเฉลี่ย 91% จากวันที่เปิดเรียนทั้งหมด</label>
			
	</div>
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.1 : 560 คน<br>มาเรียนเฉลี่ย 98% จากวันที่เปิดเรียนทั้งหมด</label>
	</div>
    <div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.2 : 528 คน<br>มาเรียนเฉลี่ย 94% จากวันที่เปิดเรียนทั้งหมด</label>
	</div>
    
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.3 : 530 คน<br>มาเรียนเฉลี่ย 89% จากวันที่เปิดเรียนทั้งหมด</label>
			
	</div>
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.4 : 624 คน<br>มาเรียนเฉลี่ย 91% จากวันที่เปิดเรียนทั้งหมด</label>
	</div>
    <div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.5 : 450 คน<br>มาเรียนเฉลี่ย 89% จากวันที่เปิดเรียนทั้งหมด</label>
	</div>
    <div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.6 : 482 คน<br>มาเรียนเฉลี่ย 87% จากวันที่เปิดเรียนทั้งหมด</label>
	</div>
    </div>
    </div>
