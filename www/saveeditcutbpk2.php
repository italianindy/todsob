...
$secondadmin=$_POST['hidsecondadmin'];
$teacherkeep=$_POST['hidteacherkeep'];
$admin=$_POST['hidadmin'];
$minusdate=$_POST['hiddatefault'];
$status=$_POST['hidstatus'];
$leaderlevelac=$_POST['hidleaderlevelac'];
$secondadminac=$_POST['hidsecondadminac'];
$adminac=$_POST['filpadminac'];
$success = false;
...
<div data-role="page" id="pageedit">
	...
	<div data-role="content">	
        ...
        <h2>สำเร็จ!</h2>	
        <p>รองผู้อำนวยการฝ่ายกิจการนักเรียนออกความคิดเห็นแล้ว</p>
        <p>&nbsp;<a href="http://112.121.150.67/thaistudentcare/pkteacherpk2.php" data-icon="home">กลับสู่เมนูหลัก</a></p>
        </div>
        <? } else { ?>
        <div style="text-align:center">
        <h2>ผิดพลาด</h2>
        <p style="color:#F00">เกิดข้อผิดพลาดในการออกความคิดเห็น</p>
        <p style="color:#F00">&nbsp;<a href="http://112.121.150.67/thaistudentcare/recordcutbehaviorpk2.php" data-role="button" data-icon="back">ลองใหม่</a></p>
        </div>
        <? }?>
	</div>
</div>
