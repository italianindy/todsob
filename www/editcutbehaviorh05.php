...
<div data-role="page" id="pageEbehavior">
    ...
    <a href="http://112.121.150.67/thaistudentcare/reportwaith05.php" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
		<h1>รอดำเนินการตัดคะแนน</h1>
	</div>
	
			<form action="saveeditcutbh05.php?mbid=<?=$objResult2["minus_id"];?>" method="post" id="form1">
