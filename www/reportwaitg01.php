...
<div data-role="page" data-theme="d" id="pageRwait">
    ...
    <a href="http://112.121.150.67/thaistudentcare/pkteacherg01.php" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
...
WHERE minusbehavior.minus_id  AND minusbehavior.minus_status = 'รอดำเนินการ' AND minusbehavior.minus_teachcut='".$_SESSION["strUserID"]."' AND minusbehavior.minus_admin = ''";
...
<li><a href="#">
  ...
  </a><a href="http://112.121.150.67/thaistudentcare/editfinishbvg01.php?mbid=<?=$objResult3["minus_id"];?>">รายละเอียด</a></li>
  <?
}
?> 
</ul>
