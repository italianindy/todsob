...
<div data-role="page" data-theme="d" id="pageDstudentkeepgrade">
...
$strSQL2 = "SELECT
a.*, b.*, c.*
FROM student a INNER JOIN (level b, grade c)
ON ( a.level_id=b.level_id AND c.stud_id=a.stud_id)
WHERE   b.level_id = '".$_GET["lid"]."' AND a.stud_status='ปกติ' AND(c.grade_level = '0' OR c.grade_level = 'ร' OR c.grade_level = 'มส' OR c.grade_level = 'มผ' )
GROUP BY a.stud_id";
...
?>   
    ...
    <div align="center">
      <img src="pic/000.png" width="250" height="80"> 			</div>
