...
?>
	...
	<div style="padding-left:10px;padding-right:10px">
      ...
      <img src="pic/welcome.png" width="240" height="120"> </div>
        ...
        <font size="3" color="#990000"><a href="http://112.121.150.67/thaistudentcare/pkteacher.php" data-icon="grid" data-role="button" data-theme="e">ฝ่ายปกครอง</a></font>
    </div>    
 <?   
}

else if ($objResult["teach_status"] == "ยกเลิก")
{
	$_SESSION["strUserID"] = $objResult["teach_id"];
?>
	...
	<div style="padding-left:10px;padding-right:10px">
      ...
      <img src="pic/welcome.png" width="240" height="120"> </div>
		<div data-role="fieldcontain" align="center">
			<font size="3" color="#990000"><label for="name">ชื่อครูผู้สอนotนะจ๊ะ : คุณ</label><? echo $objResult["teach_fname"];?> <? echo $objResult["teach_lname"];?></font>
		</div>
        <div data-role="fieldcontain" align="center">
			<font size="3" color="#990000"><label for="name">เลขบัตรประชาชน</font> <font size="3" color="#990000">: <? echo $objResult["teach_id"];?></font>
		</div>
