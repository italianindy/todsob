...
<div data-role="page" data-theme="d" id="pageRwait">
    ...
    <a href="http://112.121.150.67/thaistudentcare/pkteacherpk1.php" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
...
FROM minusbehavior  INNER JOIN student INNER JOIN fault INNER JOIN `level`
ON (minusbehavior.stud_id=student.stud_id AND minusbehavior.fault_id=fault.fault_id AND student.level_id=`level`.level_id)
WHERE minusbehavior.minus_id  AND minusbehavior.minus_status = 'รอดำเนินการ'  AND minusbehavior.minus_secondadmin = '' AND minusbehavior.minus_leaderlevel != '' AND minusbehavior.minus_admin = ''";
...
?>
  ...
  </a><a href="http://112.121.150.67/thaistudentcare/editcutbehaviorpk1.php?mbid=<?=$objResult2["minus_id"];?>">รายละเอียด</a></li>
<?
}
?> 
</ul>
...
<li><a href="#">
  ...
  </a><a href="http://112.121.150.67/thaistudentcare/editfinishbvpk1.php?mbid=<?=$objResult3["minus_id"];?>">รายละเอียด</a></li>
  <?
}
?> 
</ul>
