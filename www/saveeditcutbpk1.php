...
<div data-role="page" id="pageedit">
	...
	<div data-role="content">	
        ...
        <h2>สำเร็จ!</h2>	
        <p>ผช.รองผู้อำนวนการฝ่ายกิจการนักเรียนออกความคิดเห็นแล้ว</p>
        <p>&nbsp;<a href="http://112.121.150.67/thaistudentcare/pkteacherpk1.php" data-icon="home">กลับสู่เมนูหลัก</a></p>
        </div>
        <? } else { ?>
        <div style="text-align:center">
        <h2>ผิดพลาด</h2>
        <p style="color:#F00">เกิดข้อผิดพลาดในการออกความคิดเห็น</p>
        <p style="color:#F00">&nbsp;<a href="http://112.121.150.67/thaistudentcare/recordcutbehaviorpk1.php" data-role="button" data-icon="back">ลองใหม่</a></p>
        </div>
        <? }?>
	</div>
</div>
