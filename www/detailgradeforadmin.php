...
<div data-role="page" id="pageDgradeforadmin">
...
<div align="right">
	...
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนทั้งหมด : 3,174 คน<br>GPA เฉลี่ยนักเรียนทั้งหมด : 3.00</label>
			
	</div>
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.1 : 560 คน<br>GPA เฉลี่ย : 3.28</label>
	</div>
    <div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.2 : 528 คน<br>GPA เฉลี่ย : 2.95</label>
	</div>
    
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.3 : 530 คน<br>GPA เฉลี่ย : 2.75</label>
			
	</div>
	<div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.4 : 624 คน<br>GPA เฉลี่ย : 3.43</label>
	</div>
    <div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.5 : 450 คน<br>GPA เฉลี่ย : 3.12</label>
	</div>
    <div data-role="fieldcontain">
		<label for="name">จำนวนนักเรียนม.6 : 482 คน<br>GPA เฉลี่ย : 3.01</label>
	</div>
    </div>
    </div>
