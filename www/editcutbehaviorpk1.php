...
<div data-role="page" id="pageEbehavior">
    ...
    <a href="http://112.121.150.67/thaistudentcare/reportwaitpk1.php" data-icon="back" data-iconpos="notext" data-direction="reverse" >Back</a>
		<h1>รอดำเนินการตัดคะแนน</h1>
	</div>
	
			<form action="saveeditcutbpk1.php?mbid=<?=$objResult2["minus_id"];?>" method="post" id="form1">
       ...
       <p>ครูที่ปรึกษา ครู<? echo $objResult3["teach_fname"];?> <? echo $objResult3["teach_lname"];?> </p>
        ...
        <div data-role="fieldcontain">
          <label for="flipswitch">ความเห็นผช.ผอ.ฝ่ายกิจการนักเรียน : </label>
...
<input name="hidstudid" type="hidden" value="<? echo $objResult2["stud_id"];?>">  
       ...
       <input name="hidsecondadmin" type="hidden" value="<? echo $objResult["teach_id"];?>">
